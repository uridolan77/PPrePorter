...
namespace PPrePorter.Infrastructure.Interfaces
{
    /// <summary>
    ...
    public interface IMetadataService
    {
        ...
        Task<List<MetadataItem>> GetCountriesAsync(bool includeInactive = false);
        ...
        Task<List<MetadataItem>> GetCurrenciesAsync(bool includeInactive = false);
        ...
        Task<List<MetadataItem>> GetWhiteLabelsAsync(bool includeInactive = false);

...
namespace PPrePorter.Infrastructure.Services
{
    ...
    public class MetadataService : IMetadataService
    {
        ...
        private const string CacheKeyPrefix = "DailyActionsMetadata_";
        ...
        /// Gets all countries
        /// </summary>
        public Task<List<MetadataItem>> GetCountriesAsync(bool includeInactive = false)
        {
            return GetMetadataByTypeAsync(MetadataTypes.Country, includeInactive);
        }

        /// <summary>
        /// Gets all currencies
        /// </summary>
        public Task<List<MetadataItem>> GetCurrenciesAsync(bool includeInactive = false)
        {
            return GetMetadataByTypeAsync(MetadataTypes.Currency, includeInactive);
        }

        /// <summary>
        /// Gets all white labels
        /// </summary>
        public Task<List<MetadataItem>> GetWhiteLabelsAsync(bool includeInactive = false)
        {
            return GetMetadataByTypeAsync(MetadataTypes.WhiteLabel, includeInactive);
        }

 ...
 */
const DashboardStory = ({ storyData, isLoading, onAnnotate, onSaveInsight }) => {
  ...
  const handleRemoveSavedInsight = (insightKey) => {
...
/**
 * Single insight list item with actions
 */
const InsightListItem = ({ insight, isSaved, onSave, onRemove, onAnnotate }) => {
  const [expanded, setExpanded] = useState(false);
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', mt: 1, gap: 1 }}>
        ...
        <Chip
          size="small"
          icon={getTrendIcon(insight.TrendDirection)}
...
// Helper function to get insight icon based on type and importance
const getInsightIcon = (insight) => {
  if (insight.InsightType === 'Anomaly') {

 ...
 */
const NaturalLanguageQuery = ({ height = 600 }) => {
  ...
  const [queryFeedback, setQueryFeedback] = useState({ severity: 'info', message: '' });
  ...
  const handleToggleFavorite = (queryText) => {
  ...
  const isFavoriteQuery = (queryText) => {

...
const ReportScheduler: React.FC<ReportSchedulerProps> = ({
  ...
  const renderDayOfWeekSelector = (): React.ReactNode => {
    return (
      <FormControl fullWidth margin="normal">
        <InputLabel>Day of Week</InputLabel>
        <Select
          value={currentSchedule.dayOfWeek || 1}
          onChange={(e) => handleChange('dayOfWeek', e.target.value as number)}
          label="Day of Week"
        >
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ mt: 2 }}>
                <TimePicker
                  ...
                  onChange={(newTime) => handleChange('time', newTime as Date)}
                  ampm={true}
                  slotProps={{
                    textField: {
                      fullWidth: true,
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <DatePicker
                      ...
                      onChange={(newDate) => handleChange('startDate', newDate as Date)}
                      slotProps={{
                        textField: {
                          fullWidth: true,
                          variant: 'outlined'
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                      ...
                      {currentSchedule.hasEndDate && (
                        <DatePicker
                          ...
                          onChange={(newDate) => handleChange('endDate', newDate as Date)}
                          slotProps={{
                            textField: {
                              fullWidth: true,
                              variant: 'outlined'
              ...
              <Box sx={{ mt: 3 }}>
                ...
                <FormControl fullWidth margin="normal">
                  ...
                  <Select
                    ...
                    onChange={(e) => handleChange('format', e.target.value as Schedule['format'])}
                    label="Export Format"
                  >

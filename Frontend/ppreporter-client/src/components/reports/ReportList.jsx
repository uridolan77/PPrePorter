 ...
 * @param {Array} props.reports - List of reports to display
 * @param {Function} props.onViewReport - Function called when a report is viewed
 * @param {Function} props.onCreateReport - Function called when a new report is created
 ...
 * @param {number} props.totalCount - Total number of reports available
 * @param {string} props.error - Error message to display
 * @param {Array} props.categories - Available report categories
...
const ReportList = ({
  ...
  const handleToggleFavorite = (event, report) => {
    event.stopPropagation();
    if (onFavoriteToggle) {

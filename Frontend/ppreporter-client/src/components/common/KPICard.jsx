 ...
 * @param {number} props.trend - Trend percentage change (positive or negative)
 * @param {string} props.trendLabel - Label for the trend value
 * @param {React.ReactNode} props.icon - Optional icon to display
 * @param {boolean} props.loading - Whether data is loading
 * @param {Function} props.onMoreClick - Callback for more options button
 * @param {string} props.color - Optional color override
 * @param {boolean} props.isInverse - Whether positive trends should be shown in red (e.g. for cost metrics)
 */
const KPICard = ({
  title,
  value,
